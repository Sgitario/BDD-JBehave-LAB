<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="com.sgitario.jbehave.bmicalculator.domain.WeightCategory"%>
<%@page import="com.sgitario.jbehave.bmicalculator.domain.HealthRecord"%>
<%@ page import="com.sgitario.jbehave.bmicalculator.domain.BodyMassIndex"%> 
<%@ page import="com.sgitario.jbehave.bmicalculator.web.WebConstants"%>
